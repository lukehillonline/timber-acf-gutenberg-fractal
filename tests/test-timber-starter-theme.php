<?php
	...
	class TimberACFGutenbergFractalTheme extends WP_UnitTestCase {

		function setUp() {
			self::_setupTimberACFGutenbergFractalTheme();
		...
		function testFunctionsPHP() {
			$context = Timber::context();
			$this->assertEquals('TimberACFGutenbergFractalSite', get_class($context['site']));
		...
		static function _setupTimberACFGutenbergFractalTheme(){
